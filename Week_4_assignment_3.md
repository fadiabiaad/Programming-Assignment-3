...
github repo for rest of specialization: [Data Science Coursera](https://github.com/fadiabiaad/Programming-Assignment-3)


###  Part 1 Plot the 30-day mortality rates for heart attack ([outcome.R](https://github.com/fadiabiaad/Programming-Assignment-3/outcome.R))
...
###  Part 2 Finding the best hospital in a state ([best.R](https://github.com/fadiabiaad/Programming-Assignment-3/best.R))
```R
...
```
###  Part 3 Ranking hospitals by outcome in a state ([rankhospital.R](https://github.com/fadiabiaad/Programming-Assignment-3/rankhospital.R))
```R
...
```
###  Part 4 Ranking hospitals in all states ([rankall.R](https://github.com/fadiabiaad/Programming-Assignment-3/rankall.R))
```R
